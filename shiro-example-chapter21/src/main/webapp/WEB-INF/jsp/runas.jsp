...
<c:if test="${isRunas}">
    ...
    |
    <a href="<%=basePath%>/runas/switchBack">切换回该身份</a>
</c:if>
        ...
        <table class="table">
            ...
            <c:forEach items="${fromUserIds}" var="id">
                <tr>
                    ...
                    <td>
                        <a href="<%=basePath%>/runas/switchTo/${id}">切换到该身份</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
            ...
            <td>
                <c:choose>
                    <c:when test="${zhang:in(toUserIds, u.id)}">
                        <a href="<%=basePath%>/runas/revoke/${u.id}">回收身份</a>
                    </c:when>
                    <c:otherwise>
                        <a href="<%=basePath%>/runas/grant/${u.id}">授予身份</a>
                    </c:otherwise>
                </c:choose>
            </td>
        </tr>
